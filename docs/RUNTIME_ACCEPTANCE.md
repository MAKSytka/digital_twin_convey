...
| Полноширинный инфид-сепаратор | требуется повторный запуск после перехода на сплошные ролики | предыдущая дисковая версия подтверждена 2026-08-01 | повторная проверка |
...
## 2. Инфид-сепаратор — повторная проверка после изменения механики
...
- длинные узкие товары поперечной ориентации проходят через 70-мм продольные промежутки;
- крупные товары не проходят сквозь ролики;
