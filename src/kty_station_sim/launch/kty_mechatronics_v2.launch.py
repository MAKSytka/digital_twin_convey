...
from kty_station_sim.world_patch_v2 import build_balanced_world
...
def generate_launch_description() -> LaunchDescription:
    ...
    generated_world = Path(tempfile.gettempdir()) / "kty_mechatronics_v2.sdf"
    ...
    controller = Node(
        ...
        name="kty_mechatronics_cycle_v2",
        output="screen",
        parameters=[
            {
                "use_sim_time": False,
    ...
    return LaunchDescription(
        [
            ...
            # 0.65 s produced an uncontrolled heap.  1.15 s is 1.77 times
            # slower while still filling a KTY quickly enough for testing.
            ...
            # Mechanics acceptance starts headless to protect RTF.  The
            # dashboard topic remains available; set true after transport works.
