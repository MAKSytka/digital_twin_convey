...
# their short side becomes the longitudinal projection that can enter a 70 mm
# opening between adjacent rollers.
...
class ContinuousRollerSeparatorSpawner(SeparatorDemoSpawner):
    ...
    def _make_box(
        ...
        for _ in range(2500):
            ...
            # the direction of travel and the 70 mm gap between roller rows.
